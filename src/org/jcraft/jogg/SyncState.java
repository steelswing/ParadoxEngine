   ...
   public int pageseek(Page var1) {
      ...
      if(this.bodybytes + this.headerbytes > var4) {
         ...
         synchronized(var11) {
            ...
            this.data[var2 + 24] = 0;
            this.data[var2 + 25] = 0;
            Page var12 = this.pageseek;
            var12.header_base = this.data;
            var12.header = var2;
            var12.header_len = this.headerbytes;
            var12.body_base = this.data;
            var12.body = var2 + this.headerbytes;
            var12.body_len = this.bodybytes;
            var12.checksum();
