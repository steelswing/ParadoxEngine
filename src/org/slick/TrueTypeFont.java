...
import org.slick.opengl.GLUtils;
import org.slick.opengl.Texture;
import org.slick.opengl.renderer.Renderer;
import org.slick.opengl.renderer.SGL;
import org.slick.util.BufferedImageUtil;
 ...
 */
public class TrueTypeFont implements org.slick.Font {
     ...
     */
    public void drawString(float x, float y, String whatchars,
            org.slick.Color color, int startIndex, int endIndex) {
        color.bind();
        fontTexture.bind();
     ...
     */
    public void drawString(float x, float y, String whatchars) {
        drawString(x, y, whatchars, org.slick.Color.white);
    }
