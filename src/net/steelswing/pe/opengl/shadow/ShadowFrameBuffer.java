...
public class ShadowFrameBuffer {
     ...
     */
    public void destroy() {
        MultiGL.glDeleteFramebuffers(fbo);
    ...
    private static int createFrameBuffer() {
        int frameBuffer = MultiGL.glGenFramebuffers();
    ...
    private static int createDepthBufferAttachment(int width, int height) {
        ...
        MultiGL.glFramebufferTexture(MultiGL.GL_FRAMEBUFFER, MultiGL.GL_DEPTH_ATTACHMENT, texture, 0);
        return texture;
    }
